    ...
    <AdminPageLayout>
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3">
        ...
        <div className="flex flex-wrap items-center gap-1.5">
          ...
          <button onClick={fetchBookings} className="p-2 bg-gray-100 dark:bg-slate-900 border border-gray-200 dark:border-slate-700 rounded-xl hover:bg-gray-200 dark:hover:bg-slate-800 transition" title="Refresh">
